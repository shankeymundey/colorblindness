...
public class Eleven extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction= Start.fragmentManager.beginTransaction().replace(R.id.fragment_container,new Twelve(),null);
    ...
    public void answer(){
        ...
        i1.setImageResource(R.drawable.elevena);
        t1.setText("“7”\tThose with normal color vision see a 7.\n" +
    ...
    public void question(){
        ...
        i1.setImageResource(R.drawable.eleven);
        t1.setText("  ");
        s=0;
    }
