...
public class Twelve extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction= Start.fragmentManager.beginTransaction().replace(R.id.fragment_container,new Thirteen(),null);
    ...
    public void answer(){
        ...
        i1.setImageResource(R.drawable.twelvea);
        t1.setText("“16”\tThose with normal color vision see a 16.\n" +
    ...
    public void question(){
        ...
        i1.setImageResource(R.drawable.twelve);
        t1.setText("  ");
        s=0;
    }
